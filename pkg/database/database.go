...
func New() {
	dsn := fmt.Sprintf("host=%v user=%v password=%v dbname=%v port=%v sslmode=disable", godotenv.Load("DB_HOST"), godotenv.Load("DB_USER"), godotenv.Load("DB_PW"), godotenv.Load("DB_NAME"), godotenv.Load("DB_PORT"))
